...
namespace COMP0003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // arrays store a collection of data of the same type (e.g., int, string, objects,etec.)

            // array1 declaration and setting values
            int[] array1 = new int[5]; // declare a single-dimensional array of 5 integer without values
            ...
            // like arrays, lists store a collection of data with the same type (e.g.,it,string,objects,etc.)
